...
1. **Download the MSI Installer**
   - Download [BIOME_1.1.0_x64_en-US.msi](./BIOME-Distribution/BIOME_1.1.0_x64_en-US.msi) (~53 MB)
...
├── msi/BIOME_1.1.0_x64_en-US.msi
└── nsis/BIOME_1.1.0_x64-setup.exe
```
...
│   └── BIOME_1.1.0_x64_en-US.msi    # Ready-to-install desktop app
├── docs/                             # Documentation
